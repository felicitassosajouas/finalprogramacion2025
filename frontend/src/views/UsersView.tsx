...
// //                 para disfrutar experiencias únicas en Mendoza.
// //               </p>
...
//                        bg-gradient-to-br from-orange-50 via-white to-sky-100
//                        dark:from-slate-900 dark:via-slate-950 dark:to-slate-900
//                        transition-colors duration-300 pt-2 pb-10 md:py-10">
...
//           {/* IMAGEN IZQUIERDA (Subida en móvil con -mt-12) */}
//           <div className="flex justify-center w-full order-1 md:order-none -mt-12 md:mt-0 transition-all duration-500">
...
//                             w-44 sm:w-60 md:w-full max-w-md">
//               <img
//                 src="/Ob2.jpeg"
//                 alt="Planificar viaje"
//                 className="w-full h-auto rounded-[1.5rem] md:rounded-[2rem] drop-shadow-xl object-contain"
//               />
//             </div>
//           </div>
...
//                              text-3xl md:text-4xl font-bold mb-4 md:mb-6 tracking-tight leading-tight">
//                 ¡Tu próxima aventura comienza acá!
//               </h1>

//               <p className="text-base md:text-lg text-slate-700 dark:text-slate-300 mb-8 md:mb-10 leading-relaxed">
//                 Completá el formulario sobre tu viaje y recibí recomendaciones
//                 para disfrutar experiencias únicas en Mendoza.
//               </p>
...
//               <Link
//                 to="/form"
//                 className="block sm:inline-block bg-[#fd6303] px-10 py-3.5 text-white text-lg
//                            font-semibold rounded-2xl shadow-lg
...
//       {/* FOOTER */}
//       <footer className="bg-[#fd6303] dark:bg-slate-950 py-6 px-3 text-white text-center text-sm md:text-base transition-colors">
//         <p>© 2026 Rumbo – Todos los derechos reservados.</p>
//       </footer>
...
export default function UsersView() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-alegreya">
      ...
      {/* CONTENIDO 
          Cambié pt-2 por pt-16 (o pt-20) para que en mobile no pegue al header. 
          Quitamos el margen negativo de la imagen.
      */}
      <main className="relative flex-grow flex items-center justify-center overflow-hidden
                       bg-gradient-to-br from-orange-50 via-white to-sky-100
                       dark:from-slate-900 dark:via-slate-950 dark:to-slate-900
                       transition-colors duration-300 pt-16 pb-10 md:pt-0 md:pb-0">
        ...
        {/* CONTENEDOR FLEX/GRID */}
        <div className="relative z-10 w-full max-w-7xl px-6 md:px-16 flex flex-col md:grid md:grid-cols-2 items-center gap-10 md:gap-12">

          {/* IMAGEN IZQUIERDA 
              Eliminé el -mt-12 que causaba el choque con el header.
          */}
          <div className="flex justify-center w-full order-1 md:order-none transition-all duration-500">
            <div className="p-3 md:p-6 bg-white/40 dark:bg-slate-800/40 backdrop-blur-md
                            rounded-[2.5rem] md:rounded-[3rem] shadow-xl border border-white/50 dark:border-slate-700
